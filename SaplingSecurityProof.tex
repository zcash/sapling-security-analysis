...
\end{thm}
 ...
 Define the two functions
   \[ P = 4Q/\gamma, T=\lceil \ln 3 P /2\rceil.\]
  ...
  We first show that given \rand, \ext succeeds w.p. at least $2/3$ over its inner randomness.
  ...
  Next, we bound the probability of $\rand\in \F^Q$ belonging to a set \goodset{\rand}{i}
  ...
  Now using these two subclaims, the probability of \ext succeeding to output \sk is at least the probability of \rand being good and in
  a set \goodset{\rand}{i} of density at least $1/P$ in \bigset{\rand}{i}; multiplied by the probability of success conditioned on that. This gives success probability at least
